...
type MeteringPointDetail struct {
	...
	GridOperatorIDSchemeAgencyID    string               `json:"gridOperatorID_SchemeAgencyIdentifier"`
	...
	PowerLimitKWDecimal             *float64             `json:"powerLimitKWDecimal"`
	...
	BalanceSupplierName             string               `json:"balanceSupplierName"`
	BalanceSupplierID               string               `json:"balanceSupplierId"`
	BalanceSupplierIDSchemeAgencyID string               `json:"balanceSupplierId_SchemeAgencyIdentifier"`
	...
	Occurrence                      FlexibleTime         `json:"occurrence"`
	MeteringPointAlias              string               `json:"meteringPointAlias"`
	AssetType                       string               `json:"assetType"`
	MpAddressWashInstructions       string               `json:"mpAddressWashInstructions"`
	DarReference                    string               `json:"darReference"`
...
type ContactAddress struct {
	...
	ProtectedAddress    string `json:"protectedAddress"`
}
